...
FAQS: list[tuple[str, str]] = [
    ...
    (
        ...
        "1st and 2nd mortgages and HELOC cap at up to 75% LTV (case by case). Construction and commercial cap at up to 65% LTV (case by case). All are subject to property type, location, and borrower profile, with a minimum credit score of 600.",
    ),
    (
...
def build_post_prose() -> str:
  ...
  <ul {UL_STYLE}>
    ...
    <li>Published LTV caps: <strong>75% LTV (case by case)</strong> on 1st, 2nd, and HELOC; <strong>65% LTV (case by case)</strong> on construction and commercial.</li>
    <li>A one-page deal note with a credible exit is the fastest path to a same-day commitment.</li>
    <li>Richview publishes starting rates from <strong>6.49%</strong> on 1sts and <strong>8.99%</strong> on 2nds — all subject to approval.</li>
  </ul>
  ...
  <ul {UL_STYLE}>
    <li><strong>First mortgages:</strong> from <strong>6.49%</strong>, 2% lender fee, open &amp; closed 6&ndash;12 month terms, up to 75% LTV (case by case). Maximum loan amount up to $5,000,000. (For Toronto and GTA specifics, see our <a href="/blog/private-mortgage-lender-toronto-honest-gta-guide/">honest GTA private lending guide</a>.)</li>
    <li><strong>Second mortgages:</strong> from <strong>8.99%</strong>, 2% lender fee, open and closed 6&ndash;12 month terms, up to 75% LTV (case by case). Loans up to $1M. Low-LTV files may not require an appraisal.</li>
    <li><strong>Construction loans:</strong> 1st from <strong>8.99%</strong>, 2nd from <strong>10.99%</strong>, 2% lender fee, up to 65% LTV (case by case), with 3&ndash;5 draws per project and 24-hour on-site inspections. See <a href="/blog/private-construction-loan-ontario/">private construction loan Ontario</a>.</li>
    <li><strong>HELOC:</strong> 1st from <strong>7.99%</strong>, 2nd from <strong>8.99%</strong>, 2.5% lender fee, open term/readvancable, up to 75% LTV (case by case).</li>
    <li><strong>Commercial:</strong> from <strong>7.99%</strong>, 2% lender fee, open and closed 6&ndash;12 month terms, up to 65% LTV (case by case).</li>
    <li><strong>Bridge and land:</strong> evaluated case by case.</li>
  </ul>
  ...
  <div class="post-table-wrap">
    <table>
      ...
      <tbody>
        <tr><td>First mortgage (purchase)</td><td>from 6.49%</td><td>2%</td><td>6–12 months</td><td>Up to 75% LTV (case by case)</td></tr>
        <tr><td>First mortgage (refinance)</td><td>from 6.49%</td><td>2%</td><td>6–12 months</td><td>Up to 75% LTV (case by case)</td></tr>
        <tr><td>Second mortgage</td><td>from 8.99%</td><td>2%</td><td>6–12 months</td><td>Up to 75% LTV (case by case)</td></tr>
        <tr><td>Land (1st mortgage)</td><td>Case by case</td><td>2%</td><td>Case by case</td><td>65% LTV</td></tr>
        <tr><td>Construction (1st mortgage)</td><td>from 8.99%</td><td>2%</td><td>6–12 months</td><td>Up to 65% LTV (case by case)</td></tr>
        <tr><td>Construction (2nd mortgage)</td><td>from 10.99%</td><td>2%</td><td>6–12 months</td><td>Up to 65% LTV (case by case)</td></tr>
        <tr><td>Bridge</td><td>Case by case</td><td>1–2%</td><td>1–90 days</td><td>Case by case</td></tr>
        <tr><td>HELOC (1st)</td><td>from 7.99%</td><td>2.5%</td><td>Open / readvancable</td><td>Up to 75% LTV (case by case)</td></tr>
        <tr><td>HELOC (2nd)</td><td>from 8.99%</td><td>2.5%</td><td>Open / readvancable</td><td>Up to 75% LTV (case by case)</td></tr>
        <tr><td>Commercial</td><td>from 7.99%</td><td>2%</td><td>6–12 months</td><td>Up to 65% LTV (case by case)</td></tr>
      </tbody>
    </table>
  </div>
  <p>Maximum loan amount up to <strong>$5,000,000</strong> on residential first mortgages; second mortgages cap at <strong>$1M</strong>. All rates subject to change; all mortgages subject to credit approval and appraisal.</p>
  ...
  <p>Most of the submission friction in this guide — the deal-note format, the LTV bands, the same-day commitment promise — is what we built Richview Capital around. We are a licensed Ontario <span class="key-term">MIC</span> (Lic #13171), not a broker, and we never compete for your clients. Our process is built so that a clean, complete file gets same-day feedback and can close in as little as 48 hours, with first mortgages from <strong>6.49%</strong>, second mortgages from <strong>8.99%</strong>, and loans up to <strong>$5,000,000</strong> across the GTA.</p>
...
{tags_html}
  ...
  <p class="post-byline"><strong>Richview Capital MIC</strong> is a licensed Mortgage Investment Corporation (Mortgage Administrator License #13171) and a member of ONMICA. Educational information for Ontario mortgage brokers — not legal or compliance advice. See <a href="/about-us/">About</a> and <a href="/disclaimer/">Disclaimer</a>.</p>"""
