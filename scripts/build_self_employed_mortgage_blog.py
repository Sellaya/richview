...
FAQS: list[tuple[str, str]] = [
    ...
    (
        ...
        "Richview publishes up to 75% LTV (case by case) on 1st and 2nd mortgages. As a general market rule of thumb, combined financing often reaches about 75% of value on standard residential properties.",
    ),
    (
...
def build_post_prose() -> str:
  ...
  <ul {UL_STYLE}>
    <li><strong>Equity and loan-to-value (LTV).</strong> How much of the property&apos;s value the loan represents. Richview publishes up to 75% LTV (case by case) on 1st and 2nd mortgages.</li>
